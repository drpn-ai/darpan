...
import static reconciliation.sample.RuleConditionParser.parseCondition

@Field final def logger = LoggerFactory.getLogger("reconciliation.sample.RuleServices")
